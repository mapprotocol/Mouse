...
type Database struct {
	diskdb mosdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb mosdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb mosdb.KeyValueStore, cache int, journal string) *Database {
...
func (db *Database) DiskDB() mosdb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch mosdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
