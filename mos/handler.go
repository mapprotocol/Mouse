...
func (pm *ProtocolManager) handleOtherMsg(p *peer) error {
	...
	case msg.Code == GetMMRReceiptProofMsg:
		...
		if err != nil {
			...
			if err != nil {
				...
				mtProof.ChainProof.Res = data
				mtProof.ChainProof.Remote = nil
	...
	case msg.Code == MMRReceiptProofMsg:
		...
		cp := pm.ulVP.MakeUvlpChainProof(request.ChainProof.Res)
		request.ChainProof = cp
