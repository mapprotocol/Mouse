...
// Package mos implements the Ethereum protocol.
package mos
...
func New(stack *node.Node, config *Config) (*Ethereum, error) {
	...
	if config.SyncMode == downloader.LightSync {
		return nil, errors.New("can't run mos.Ethereum in light sync mode, use les.LightEthereum")
	}
...
func (s *Ethereum) ChainDb() mosdb.Database            { return s.chainDb }
