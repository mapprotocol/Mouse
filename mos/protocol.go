...
const protocolName = "mos"

// ProtocolVersions are the supported versions of the mos protocol (first is primary).
var ProtocolVersions = []uint{eth65, eth64, eth63}

// protocolLengths are the number of implemented message corresponding to different protocol versions.
var protocolLengths = map[uint]uint64{eth65: 51, eth64: 34, eth63: 17}

const protocolMaxMsgSize = 10 * 1024 * 1024 // Maximum cap on the size of a protocol message

// mos protocol message codes
const (
	StatusMsg          = 0x00
...
// statusData63 is the network packet for the status message for mos/63.
...
// statusData is the network packet for the status message for mos/64 and later.
