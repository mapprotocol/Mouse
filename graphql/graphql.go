...
// Package graphql provides a GraphQL interface to mouse node data.
package graphql
...
// Account represents an mouse account at a particular block.
type Account struct {
...
// Transaction represents an mouse transaction.
...
// Block represents an mouse block.
...
type CallData struct {
	From     *common.Address // The mouse address the call is from.
	To       *common.Address // The mouse address the call is to.
