...
func makeHeaderChain(parent *types.Header, n int, db mosdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (mosdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() mosdb.Database {
	return odr.db
}
