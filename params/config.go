...
var (
	...
	// and accepted by the Mouse core developers into the Ethash consensus.
	//
	...
	// and accepted by the Mouse core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	YoloV1Block *big.Int `json:"yoloV1Block,omitempty"` // YOLO v1
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gmos isn't pluggable enough
