...
import (
	...
	"github.com/marcopoloprotoco/mouse/accounts/scwallet"
...
// PublicEthereumAPI provides an API to access Mouse related information.
...
// ProtocolVersion returns the current Mouse protocol version this node supports
...
// Sign calculates an Mouse ECDSA signature for:
...
//
// https://github.com/marcopoloprotoco/mouse/wiki/Management-APIs#personal_sign
...
//
// https://github.com/marcopoloprotoco/mouse/wiki/Management-APIs#personal_ecRecover
...
// Unpair deletes a pairing between wallet and gmos.
...
// PublicBlockChainAPI provides an API to access the Mouse blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Mouse blockchain API.
...
func SubmitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) {
	...
	log.Info("SubmitTransaction", "tx", tx, " data ", tx.Data(), "chainID", tx.ChainId(), "from", from, "err", err)
...
// PublicDebugAPI is the collection of Mouse APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of Mouse APIs exposed over the private
// debugging endpoint.
...
// Version returns the current mouse protocol version.
