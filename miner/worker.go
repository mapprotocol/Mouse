...
func (w *worker) builtinTxA() (txs []*types.Transaction) {
	token := types.NewContractCreation(
		...
		big.NewInt(37),
		hexutil.MustDecodeBig("0x7cb73d2972f4963ea8500313d5dedb79226c401a825e47448d1019633acf0c1b"),
		hexutil.MustDecodeBig("0x52a1b753c5bd785aa3de45b203aa21604d222fdaec2d2c599d3d711a2c6fd085"),
	)
...
func (w *worker) builtinTxB() (txs []*types.Transaction) {
	token := types.NewContractCreation(
		...
		big.NewInt(41),
		hexutil.MustDecodeBig("0xb76a0f90cb1e4210c136a600c145d18b19e90da4c4a4162318ec021560e32589"),
		hexutil.MustDecodeBig("0x1e9689d64f5da6b81f2599728722ca1ca98b3f07d991766b31aa907b1034f5ea"),
	)
