...
import (
	...
	"github.com/marcopoloprotoco/mouse/p2p/simulations"
	"github.com/marcopoloprotoco/mouse/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	mouse, err := mos.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, mouse, &config)
	if err != nil {
		return nil, err
	}
	return mouse, nil
