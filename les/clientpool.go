...
func newClientPool(db mosdb.Database, freeClientCap uint64, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
...
func newNodeDB(db mosdb.Database, clock mclock.Clock) *nodeDB {
