...
func (c *lesCommons) setupOracle(node *node.Node, genesis common.Hash, ethconfig *mos.Config) *checkpointoracle.CheckpointOracle {
	...
	client := mosclient.NewClient(rpcClient)
	oracle.Start(client)
