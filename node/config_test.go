...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gmos.ipc", false, filepath.Join(os.TempDir(), "gmos.ipc")},
		{"data", "gmos.ipc", false, "data/gmos.ipc"},
		{"data", "./gmos.ipc", false, "./gmos.ipc"},
		{"data", "/gmos.ipc", false, "/gmos.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gmos.ipc", true, `\\.\pipe\gmos.ipc`},
		{"data", "gmos.ipc", true, `\\.\pipe\gmos.ipc`},
		{"data", `\\.\pipe\gmos.ipc`, true, `\\.\pipe\gmos.ipc`},
	}
