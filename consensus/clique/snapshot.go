...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db mosdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db mosdb.Database) error {
