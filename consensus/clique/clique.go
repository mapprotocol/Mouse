...
// ecrecover extracts the Mouse account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Mouse address
...
// Mouse testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     mosdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Mouse address of the signing key
...
func New(config *params.CliqueConfig, db mosdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Mouse address recovered
