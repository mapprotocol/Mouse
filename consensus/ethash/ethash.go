...
// all blocks' seal as valid, though they still have to conform to the Mouse
// consensus rules.
...
// still have to conform to the Mouse consensus rules.
...
// they still have to conform to the Mouse consensus rules.
...
func (ethash *Ethash) APIs(chain consensus.ChainHeaderReader) []rpc.API {
	...
	// to both mos and ethash namespaces.
	return []rpc.API{
		{
			Namespace: "mos",
			Version:   "1.0",
