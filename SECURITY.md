...
Audit reports are published in the `docs` folder: https://github.com/marcopoloprotoco/mouse/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gmos` | 20170425 | [pdf](https://github.com/marcopoloprotoco/mouse/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/marcopoloprotoco/mouse/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in Mouse visit [https://bounty.ethereum.org](https://bounty.ethereum.org) or email bounty@ethereum.org.
