...
// Package utils contains internal helper functions for mouse commands.
package utils
...
import (
	...
	"github.com/marcopoloprotoco/mouse/common/fdlimit"
	...
	"github.com/marcopoloprotoco/mouse/les"
...
var (
	...
	defaultSyncMode = mos.DefaultConfig.SyncMode
	...
	LightServeFlag = cli.IntFlag{
		...
		Value: mos.DefaultConfig.LightServ,
	}
	LightIngressFlag = cli.IntFlag{
		Name:  "light.ingress",
		Usage: "Incoming bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: mos.DefaultConfig.LightIngress,
	}
	LightEgressFlag = cli.IntFlag{
		Name:  "light.egress",
		Usage: "Outgoing bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: mos.DefaultConfig.LightEgress,
	}
	LightMaxPeersFlag = cli.IntFlag{
		Name:  "light.maxpeers",
		Usage: "Maximum number of light clients to serve, or light servers to attach to",
		Value: mos.DefaultConfig.LightPeers,
	}
	UltraLightServersFlag = cli.StringFlag{
		Name:  "ulc.servers",
		Usage: "List of trusted ultra-light servers",
		Value: strings.Join(mos.DefaultConfig.UltraLightServers, ","),
	}
	UltraLightFractionFlag = cli.IntFlag{
		Name:  "ulc.fraction",
		Usage: "Minimum % of trusted ultra-light servers required to announce a new head",
		Value: mos.DefaultConfig.UltraLightFraction,
	}
	...
	EthashCachesInMemoryFlag = cli.IntFlag{
		...
		Value: mos.DefaultConfig.Ethash.CachesInMem,
	}
	EthashCachesOnDiskFlag = cli.IntFlag{
		Name:  "ethash.cachesondisk",
		Usage: "Number of recent ethash caches to keep on disk (16MB each)",
		Value: mos.DefaultConfig.Ethash.CachesOnDisk,
	}
	...
	EthashDatasetDirFlag = DirectoryFlag{
		...
		Value: DirectoryString(mos.DefaultConfig.Ethash.DatasetDir),
	}
	EthashDatasetsInMemoryFlag = cli.IntFlag{
		Name:  "ethash.dagsinmem",
		Usage: "Number of recent ethash mining DAGs to keep in memory (1+GB each)",
		Value: mos.DefaultConfig.Ethash.DatasetsInMem,
	}
	EthashDatasetsOnDiskFlag = cli.IntFlag{
		Name:  "ethash.dagsondisk",
		Usage: "Number of recent ethash mining DAGs to keep on disk (1+GB each)",
		Value: mos.DefaultConfig.Ethash.DatasetsOnDisk,
	}
	...
	TxPoolPriceLimitFlag = cli.Uint64Flag{
		...
		Value: mos.DefaultConfig.TxPool.PriceLimit,
	}
	TxPoolPriceBumpFlag = cli.Uint64Flag{
		Name:  "txpool.pricebump",
		Usage: "Price bump percentage to replace an already existing transaction",
		Value: mos.DefaultConfig.TxPool.PriceBump,
	}
	TxPoolAccountSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.accountslots",
		Usage: "Minimum number of executable transaction slots guaranteed per account",
		Value: mos.DefaultConfig.TxPool.AccountSlots,
	}
	TxPoolGlobalSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.globalslots",
		Usage: "Maximum number of executable transaction slots for all accounts",
		Value: mos.DefaultConfig.TxPool.GlobalSlots,
	}
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		Name:  "txpool.accountqueue",
		Usage: "Maximum number of non-executable transaction slots permitted per account",
		Value: mos.DefaultConfig.TxPool.AccountQueue,
	}
	TxPoolGlobalQueueFlag = cli.Uint64Flag{
		Name:  "txpool.globalqueue",
		Usage: "Maximum number of non-executable transaction slots for all accounts",
		Value: mos.DefaultConfig.TxPool.GlobalQueue,
	}
	TxPoolLifetimeFlag = cli.DurationFlag{
		Name:  "txpool.lifetime",
		Usage: "Maximum amount of time non-executable transaction are queued",
		Value: mos.DefaultConfig.TxPool.Lifetime,
	}
	...
	CacheTrieJournalFlag = cli.StringFlag{
		...
		Value: mos.DefaultConfig.TrieCleanCacheJournal,
	}
	CacheTrieRejournalFlag = cli.DurationFlag{
		Name:  "cache.trie.rejournal",
		Usage: "Time interval to regenerate the trie cache journal",
		Value: mos.DefaultConfig.TrieCleanCacheRejournal,
	}
	...
	MinerGasTargetFlag = cli.Uint64Flag{
		...
		Value: mos.DefaultConfig.Miner.GasFloor,
	}
	MinerGasLimitFlag = cli.Uint64Flag{
		Name:  "miner.gaslimit",
		Usage: "Target gas ceiling for mined blocks",
		Value: mos.DefaultConfig.Miner.GasCeil,
	}
	MinerGasPriceFlag = BigFlag{
		Name:  "miner.gasprice",
		Usage: "Minimum gas price for mining a transaction",
		Value: mos.DefaultConfig.Miner.GasPrice,
	}
	...
	MinerRecommitIntervalFlag = cli.DurationFlag{
		...
		Value: mos.DefaultConfig.Miner.Recommit,
	}
	...
	RPCGlobalGasCap = cli.Uint64Flag{
		...
		Value: mos.DefaultConfig.RPCGasCap,
	}
	RPCGlobalTxFeeCap = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in ether) that can be sent via the RPC APIs (0 = no cap)",
		Value: mos.DefaultConfig.RPCTxFeeCap,
	}
	// Logging and debug settings
	EthStatsURLFlag = cli.StringFlag{
		Name:  "mosstats",
		Usage: "Reporting URL of a mosstats service (nodename:secret@host:port)",
	}
	...
	GpoBlocksFlag = cli.IntFlag{
		...
		Value: mos.DefaultConfig.GPO.Blocks,
	}
	GpoPercentileFlag = cli.IntFlag{
		Name:  "gpo.percentile",
		Usage: "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value: mos.DefaultConfig.GPO.Percentile,
	}
	GpoMaxGasPriceFlag = cli.Int64Flag{
		Name:  "gpo.maxprice",
		Usage: "Maximum gas price will be recommended by gpo",
		Value: mos.DefaultConfig.GPO.MaxPrice.Int64(),
	}
...
func setLes(ctx *cli.Context, cfg *mos.Config) {
	...
	if cfg.UltraLightFraction <= 0 && cfg.UltraLightFraction > 100 {
		log.Error("Ultra light fraction is invalid", "had", cfg.UltraLightFraction, "updated", mos.DefaultConfig.UltraLightFraction)
		cfg.UltraLightFraction = mos.DefaultConfig.UltraLightFraction
	}
...
// for Gmos and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gmos account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func setEtherbase(ctx *cli.Context, ks *keystore.KeyStore, cfg *mos.Config) {
...
func setGPO(ctx *cli.Context, cfg *gasprice.Config, light bool) {
	...
	if light {
		cfg.Blocks = mos.DefaultLightGPOConfig.Blocks
		cfg.Percentile = mos.DefaultLightGPOConfig.Percentile
	}
...
func setEthash(ctx *cli.Context, cfg *mos.Config) {
...
func setWhitelist(ctx *cli.Context, cfg *mos.Config) {
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated")
	}
}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *mos.Config) {
	...
	case ctx.GlobalBool(LegacyTestnetFlag.Name) || ctx.GlobalBool(RopstenFlag.Name):
		...
		cfg.OtherGenesis = core.DefaultOtherRopstenGenesisBlock()
	...
	case ctx.GlobalBool(GoerliFlag.Name):
		...
		cfg.OtherGenesis = core.DefaultOtherGoerliGenesisBlock()
		setDNSDiscoveryDefaults(cfg, params.GoerliGenesisHash)
	case ctx.GlobalBool(YoloV1Flag.Name):
		if !ctx.GlobalIsSet(NetworkIdFlag.Name) {
...
// no URLs are set.
func setDNSDiscoveryDefaults(cfg *mos.Config, genesis common.Hash) {
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "gmos.", tagsMap)
		}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) mosdb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node, readOnly bool) (chain *core.BlockChain, chainDb mosdb.Database) {
	var err error
	chainDb = MakeChainDatabase(ctx, stack)
	...
	if config.Clique != nil {
		...
		if !ctx.GlobalBool(FakePoWFlag.Name) {
			engine = ethash.New(ethash.Config{
				CacheDir:         stack.ResolvePath(mos.DefaultConfig.Ethash.CacheDir),
				CachesInMem:      mos.DefaultConfig.Ethash.CachesInMem,
				CachesOnDisk:     mos.DefaultConfig.Ethash.CachesOnDisk,
				CachesLockMmap:   mos.DefaultConfig.Ethash.CachesLockMmap,
				DatasetDir:       stack.ResolvePath(mos.DefaultConfig.Ethash.DatasetDir),
				DatasetsInMem:    mos.DefaultConfig.Ethash.DatasetsInMem,
				DatasetsOnDisk:   mos.DefaultConfig.Ethash.DatasetsOnDisk,
				DatasetsLockMmap: mos.DefaultConfig.Ethash.DatasetsLockMmap,
			}, nil, false)
		}
	}
	if gcmode := ctx.GlobalString(GCModeFlag.Name); gcmode != "full" && gcmode != "archive" {
	...
	cache := &core.CacheConfig{
		TrieCleanLimit:      mos.DefaultConfig.TrieCleanCache,
		TrieCleanNoPrefetch: ctx.GlobalBool(CacheNoPrefetchFlag.Name),
		TrieDirtyLimit:      mos.DefaultConfig.TrieDirtyCache,
		TrieDirtyDisabled:   ctx.GlobalString(GCModeFlag.Name) == "archive",
		TrieTimeLimit:       mos.DefaultConfig.TrieTimeout,
		SnapshotLimit:       mos.DefaultConfig.SnapshotCache,
	}
	if !ctx.GlobalIsSet(SnapshotFlag.Name) {
...
// new format.
//
// e.g. gmos account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gmos --keystore /tmp/mykeystore --lightkdf account new
//
