...
import (
	...
	"github.com/marcopoloprotoco/mouse/internal/cmdtest"
	"github.com/marcopoloprotoco/mouse/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gmos-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func runGmos(t *testing.T, args ...string) *testgeth {
	...
	// Boot "gmos". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gmos-test", args...)
