...
# 1. install gmos for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gmos
# 5. create gmos, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gmos is installed global
