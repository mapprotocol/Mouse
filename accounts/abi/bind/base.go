...
type TransactOpts struct {
	From   common.Address // Mouse account to send the transaction from
...
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Mouse blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Mouse methods
...
func (c *BoundContract) Call(opts *CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = mouse.CallMsg{From: opts.From, To: &c.address, Data: input}
...
func (c *BoundContract) transact(opts *TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	...
	if gasLimit == 0 {
		...
		msg := mouse.CallMsg{From: opts.From, To: contract, GasPrice: gasPrice, Value: value, Data: input}
