...
func (mc *mockCaller) CallContract(ctx context.Context, call mouse.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call mouse.CallMsg) ([]byte, error) {
