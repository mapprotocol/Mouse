...
import (
	...
	"github.com/marcopoloprotoco/mouse/signer/core"
)
...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain mouse.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to mouse-type signature.
		signature[64] -= 27 // Transform V from Mouse-legacy to 0/1
	}
