...
func NewTable(db mosdb.Database, prefix string) mosdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) mosdb.Iterator {
...
func (t *table) NewBatch() mosdb.Batch {
...
func (b *tableBatch) Replay(w mosdb.KeyValueWriter) error {
