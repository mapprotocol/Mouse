...
func ReadDatabaseVersion(db mosdb.KeyValueReader) *uint64 {
	var version uint64
...
func WriteDatabaseVersion(db mosdb.KeyValueWriter, version uint64) {
...
func ReadChainConfig(db mosdb.KeyValueReader, hash common.Hash) *params.ChainConfig {
...
func WriteChainConfig(db mosdb.KeyValueWriter, hash common.Hash, cfg *params.ChainConfig) {
	if cfg == nil {
		return
	}
