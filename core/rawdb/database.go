...
import (
	...
	"github.com/marcopoloprotoco/mouse/mosdb/leveldb"
...
func NewDatabase(db mosdb.KeyValueStore) mosdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db mosdb.KeyValueStore, freezer string, namespace string) (mosdb.Database, error) {
...
func NewMemoryDatabase() mosdb.Database {
...
func NewMemoryDatabaseWithCap(size int) mosdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (mosdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (mosdb.Database, error) {
...
func InspectDatabase(db mosdb.Database) error {
