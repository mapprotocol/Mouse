...
// Package types contains data types related to Mouse consensus.
package types
...
// Header represents a block header in the Mouse blockchain.
type Header struct {
...
// Block represents an entire block in the Mouse blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package mos to track
...
// [deprecated by mos/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for mos protocol, etc.
...
// EncodeRLP serializes b into the Mouse RLP block format.
