...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (mosdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (mosdb.Database, func()) {
...
//
// https://github.com/marcopoloprotoco/mouse/pull/15941
...
//
// Details at:
//  - https://github.com/marcopoloprotoco/mouse/issues/18977
//  - https://github.com/marcopoloprotoco/mouse/pull/18988
