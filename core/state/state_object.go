...
// stateObject represents an mouse account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of mouse address of the account
	data     Account
	db       *StateDB
...
// Account is the mouse consensus representation of accounts.
