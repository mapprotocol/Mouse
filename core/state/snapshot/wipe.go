...
func wipeSnapshot(db mosdb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db mosdb.KeyValueStore) error {
...
func wipeKeyRange(db mosdb.KeyValueStore, kind string, prefix []byte, keylen int) error {
