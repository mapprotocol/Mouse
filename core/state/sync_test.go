...
// account array.
func checkStateAccounts(t *testing.T, db mosdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mosdb.Database, root common.Hash) error {
...
func checkStateConsistency(db mosdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(mosdb.Database), srcRoot)
