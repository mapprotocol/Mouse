...
// Package state provides a caching layer atop the mouse state trie.
package state
...
// StateDB structs within the mouse protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/marcopoloprotoco/mouse/pull/16485#issuecomment-380438527),
