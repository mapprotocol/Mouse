...
// Trie is a Mouse Merkle Patricia trie.
type Trie interface {
...
func NewDatabase(db mosdb.Database) Database {
...
// large memory cache.
func NewDatabaseWithCache(db mosdb.Database, cache int, journal string) Database {
